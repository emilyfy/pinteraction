...
void dynamic_configCb(pinteraction::board_colorConfig &config, uint32_t level) 
{
...
int main(int argc, char** argv)
{
  ...
  dynamic_reconfigure::Server<pinteraction::board_colorConfig> server;
  dynamic_reconfigure::Server<pinteraction::board_colorConfig>::CallbackType f;
